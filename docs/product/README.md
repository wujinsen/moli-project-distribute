...
| **AI 能力升级 PRD（AI-1~10）** | [`ai-capability-prd.md`](ai-capability-prd.md) | active · 2026-07-17 |
| **知识库内容管道运维 PRD（KBOPS）** | [`knowledge-ops-prd.md`](knowledge-ops-prd.md) | active · 2026-07-13 |
| **服务器运维 PRD（Operation）** | [`operation-server-ops-prd.md`](operation-server-ops-prd.md) | active · 2026-07-13 |
| **SSO 菜单隔离 PRD（SSO-MENU-1）** | [`sso-menu-isolation-prd.md`](sso-menu-isolation-prd.md) | active · 2026-07-13 |
| **知识库双入口导入 PRD（T20）** | [`knowledge-import-entry-prd.md`](knowledge-import-entry-prd.md) | ✅ T20f · 2026-07-13 |
