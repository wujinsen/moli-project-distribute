...
> 模块 **`moli-ai`**，Nacos 名 **`ai-server`**。v1 仅验证注册 + 网关 + 占位接口，见 [moli-v1-release-scope.md](../product/moli-v1-release-scope.md) §3.5。
...
| B2 | 经网关 `GET http://127.0.0.1:21000/AiServer/demo/test` | 同上（StripPrefix=1） |
| B3 | Nacos 控制台 | 实例健康 |

## 契约

- [ai-api.md](../api/ai-api.md)
