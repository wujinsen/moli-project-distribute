...
> 路由契约：[gateway-routes.md](../api/gateway-routes.md)  
> 全链路：[ARCHITECTURE.md](../zh-CN/ARCHITECTURE.md)
...
> [moli-gateway-routes.drawio](../diagrams/moli-gateway-routes.drawio)
...
完整表见 [gateway-routes.md](../api/gateway-routes.md)。
...
下游 user-center / order / knowledge 通过 **Shiro + 共享 Redis Session** 校验。时序见 [moli-auth-flow.drawio](../diagrams/moli-auth-flow.drawio)。
...
- 技术栈预留 **Sentinel**（见 [TECH_STACK.md](../zh-CN/TECH_STACK.md)）
...
- 生产：Nginx 反代同一域名，见 [nginx反向代理与前端部署指南](../../moli-knowledge/kb/wiki-ops/guides/nginx反向代理与前端部署指南.md)
...
- 冒烟：[release-smoke-checklist.md](../test/release-smoke-checklist.md) §1
- v1 范围：[moli-v1-release-scope.md](../product/moli-v1-release-scope.md)
