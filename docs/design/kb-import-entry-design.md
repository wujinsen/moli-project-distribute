...
> **任务跟踪**：[`moli-knowledge/TASKS.md`](../../moli-knowledge/TASKS.md) **T20**
...
![T20 API 时序](../diagrams/png/moli-kb-import-entry-api.png)

> 源文件：[`moli-kb-import-entry-api.drawio`](../diagrams/moli-kb-import-entry-api.drawio)
...
| 文档 | 关系 |
|------|------|
| [knowledge-import-entry-prd.md](../product/knowledge-import-entry-prd.md) | 产品需求来源 |
| [知识库设计哲学-docs-as-code.md](../../moli-knowledge/kb/wiki-moli/develop/知识库设计哲学-docs-as-code.md) | 双轨铁律 |
| [Ingest工作台产品方案](../../moli-knowledge/kb/wiki-moli/develop/Ingest工作台产品方案.md) | Tab2 不变 |
| [Wiki在线编辑与AI协助改稿.md](../../moli-knowledge/kb/wiki-moli/develop/Wiki在线编辑与AI协助改稿.md) | PUT / Sync / T14e |
| [wujinsen-wiki-image-remediation-prd.md](../product/wujinsen-wiki-image-remediation-prd.md) | T20e 插图 |
| [knowledge-workbench-operations.md](../ops/knowledge-workbench-operations.md) | 运维替代路径（至 T20 上线前仍有效） |
