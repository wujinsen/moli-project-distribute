...
import com.moli.user.center.server.controller.ActionController;
import com.moli.user.center.server.service.ActionService;
...
public class ActionControllerApiTest extends AbstractApiTest {
    ...
    public void GET_action_page() {
        PageRes<com.moli.user.center.common.domain.vo.ActionVo> page = new PageRes<>();
