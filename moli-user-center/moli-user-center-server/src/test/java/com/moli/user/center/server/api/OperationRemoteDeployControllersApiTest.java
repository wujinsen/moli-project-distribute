...
public class OperationRemoteDeployControllersApiTest extends AbstractApiTest {
    ...
    public void POST_operation_file_upload() {
        ...
        when(operationFileUploadService.createUploadTask(any(), eq(204L), any(), eq("none"))).thenReturn(99L);
        ControllerTestSupport.assertSuccess(
                fileController.upload(file, 204L, "/opt/moli-project-distribute/moli-user-center/app.jar", "none"));
    }
