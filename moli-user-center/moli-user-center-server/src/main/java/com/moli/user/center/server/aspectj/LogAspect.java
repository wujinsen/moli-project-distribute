package com.moli.user.center.server.aspectj;
...
/**
 * 操作日志：自动拦截 server.controller / server.operation.controller 包下 Controller 的 POST、PUT、DELETE。
...
public class LogAspect {
    ...
    @Pointcut("(execution(* com.moli.user.center.server.controller..*.*(..)) "
            + "|| execution(* com.moli.user.center.server.operation.controller..*.*(..))) "
