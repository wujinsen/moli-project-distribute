...
public class KbHybridRrfSupportTest {
    ...
    public void annexPenaltyLetsNgramOnlyCorrectPageWinOverDualAnnex() {
        ...
        List<Long> ngramIds = List.of(correctId);
        ...
        Map<Long, Double> fused = KbHybridRrfSupport.rrfFuse(
                ngramIds, List.of(annexHit, correctHit), RRF_K);
        Map<Long, String> slugs = KbHybridRrfSupport.slugIndexFromVectorHits(List.of(annexHit, correctHit));
    ...
    public void rrfFormulaUnchangedForNonAnnex() {
        ...
        Map<Long, Double> fused = KbHybridRrfSupport.rrfFuse(ngramIds, List.of(v), RRF_K);
