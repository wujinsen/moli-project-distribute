...
related: [git协作指南, docker部署指南, linux-运维基础, k8s入门与茉莉关系]
created: 2026-06-22
updated: 2026-06-22
---
...
**CI**：代码提交后自动构建、测试、打包，减少「在我机器能跑」问题。茉莉可选用 Jenkins 对父 POM 与各 `*-server` 模块做流水线。
...
| 方式 | 说明 |
|------|------|
| SSH 传 jar + restart | 传统单机，见 [[linux-运维基础]] |
| Docker 镜像 | build 镜像 push 仓库，见 [[docker部署指南]] |
| K8s | 更新 Deployment 镜像，见 [[k8s入门与茉莉关系]] |
...
本地 `mvn clean package` 与 CI 应使用**相同 JDK/Maven 版本**；profile 区分 dev/pro/loadtest。

## 相关

[[git协作指南]] · [[nginx反向代理与前端部署指南]]
