...
> 架构 [[middleware/rocketmq-架构与实战]]；延迟 [[cache/延迟消息与队列]]；总指南。
...
3. 批量消费 + 幂等 [[middleware/接口幂等性实践]]
4. 临时 **跳过非核心 Topic**，保秒杀主链路

## 4. 预防

- 消费逻辑无长事务；异步写库
- 监控 Lag 告警 [[ops/prometheus-告警规则设计]]
- 死信队列 + 人工补偿

## 相关

[[middleware/kafka-与-mq选型]] · [[middleware/rocketmq-事务消息实践]]
