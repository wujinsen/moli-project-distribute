---
title: 利用 Log-Pilot + Kafka + Elasticsearch + Kibana 搭建 kubernetes日志解决方案.note（原文插图 annex）
slug: annex-利用-Log-Pilot-+-Kafka-+-Elasticsearch-+-Kibana-搭建-kubernetes日志解决方案
type: article
status: active
