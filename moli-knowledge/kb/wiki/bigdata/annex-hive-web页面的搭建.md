---
title: hive web页面的搭建  .note（原文插图 annex）
slug: annex-hive-web页面的搭建
type: article
status: active
...
- 2.detached query execution：在hive命令⾏界⾯，⽤户如果需要执⾏多个查询，则需要同时打开多个 命令⾏界⾯。hwi允许⽤户同时开始多个查询，并且查看执⾏状态。

- 3.no local installation：如何⼈，只要有web browser就可以连接hive，⽽⽆需运⾏安装运⾏任何客户 端。
...
- 1.配置： $ cd /home/work/hive/hive-0.8.1/conf; $ cp hive-default.xml.template hive-site.xml
