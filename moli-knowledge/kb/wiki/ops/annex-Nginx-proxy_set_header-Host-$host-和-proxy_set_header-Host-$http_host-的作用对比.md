---
title: Nginx proxy_set_header Host $host 和 proxy_set_header Host $http_host 的作用对比.note（原文插图 annex）
slug: annex-Nginx-proxy_set_header-Host-$host-和-proxy_set_header-Host-$http_host-的作用对比
type: article
status: active
