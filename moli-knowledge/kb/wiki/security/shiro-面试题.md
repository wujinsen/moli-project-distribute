...
> [[security/shiro-鉴权体系]] [[security/shiro-starter与跨服务校验]] [[security/sso与系统门户]] [[security/认证与会话机制]]
...
引 shiro-starter + 同 Redis + Dubbo 订 user-center + 网关路由。见 [[security/shiro-starter与跨服务校验]]。
