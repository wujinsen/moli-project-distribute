...
- [bi-smoke.md](../../../docs/test/bi-smoke.md)
- [release-smoke-checklist.md](../../../docs/test/release-smoke-checklist.md) G4

## v2 展望

见 [[bi报表服务演进路线]] 与 [bi-module-overview.md](../../../docs/design/bi-module-overview.md) §6。
