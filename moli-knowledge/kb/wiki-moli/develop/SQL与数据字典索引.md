...
> 工程契约：`docs/sql/` · 一键初始化：[[数据库初始化指南]] · 顺序：[[SQL迁移顺序]]

## 表设计说明

| 文档 | 范围 |
|------|------|
| `docs/sql/USER_CENTER_SCHEMA.md` | sys_*、operation_* |
| `docs/sql/KNOWLEDGE_SCHEMA.md` | kb_* 14 表 |
| `docs/sql/KNOWLEDGE_SCHEMA_ER.png` | ER 图 PNG |

## 基线与增量脚本

| 文件 | 说明 |
|------|------|
| `scripts/moli.sql` | **推荐** 全库基线 |
...
完整清单见 `docs/sql/README.md` 与 [[SQL迁移顺序]]。
