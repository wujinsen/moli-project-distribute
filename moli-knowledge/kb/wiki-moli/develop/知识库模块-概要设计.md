...
> **知识库双轨**：`docs/diagrams/png/moli-kb-architecture.png`（请在仓库中打开 PNG；源文件见同目录 `.drawio`）


> 源文件：`docs/diagrams/moli-kb-architecture.drawio`


> **RAW 全链路**：`docs/diagrams/png/moli-kb-raw-pipeline.png`（请在仓库中打开 PNG；源文件见同目录 `.drawio`）


> 源文件：`docs/diagrams/moli-kb-raw-pipeline.drawio`
...
> **Sync 双轨**：`docs/diagrams/png/moli-knowledge-sync.png`（请在仓库中打开 PNG；源文件见同目录 `.drawio`）


> `docs/diagrams/moli-knowledge-sync.drawio`
