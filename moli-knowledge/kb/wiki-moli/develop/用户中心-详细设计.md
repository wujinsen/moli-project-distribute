...
tags: [设计, 概要设计, 架构]
sources:
  - docs/design/user-center-detailed-design.md
related:
  - 用户中心
  - 用户中心-概要设计
  - 技术方案与架构索引
...
> **浏览镜像**：工程契约权威仍在 `docs/design/user-center-detailed-design.md`；改设计请先改契约再重新运行本脚本或 Tab3 导入。

> 更新：2026-06-25 · 概要：[[用户中心-概要设计]]
