...
> **用户中心平台定位**：`docs/diagrams/png/moli-user-center-position.png`（请在仓库中打开 PNG；源文件见同目录 `.drawio`）


> 可编辑源文件：`docs/diagrams/moli-user-center-position.drawio` · 鉴权时序见 `docs/diagrams/moli-auth-flow.drawio`
...
> **RBAC 模型**：`docs/diagrams/png/moli-rbac-model.png`（请在仓库中打开 PNG；源文件见同目录 `.drawio`）


> 源文件：`docs/diagrams/moli-rbac-model.drawio`
...
> **本地部署拓扑**：`docs/diagrams/png/moli-deploy-topology.png`（请在仓库中打开 PNG；源文件见同目录 `.drawio`）
