...
![image 1](<mac搭建hadoop集群.note_images/imageFile1.png>)
...
![image 2](<mac搭建hadoop集群.note_images/imageFile2.png>)
...
![image 3](<mac搭建hadoop集群.note_images/imageFile3.png>)
...
![image 4](<mac搭建hadoop集群.note_images/imageFile4.png>)
...
![image 5](<mac搭建hadoop集群.note_images/imageFile5.png>)
...
![image 6](<mac搭建hadoop集群.note_images/imageFile6.png>)

![image 7](<mac搭建hadoop集群.note_images/imageFile7.png>)

将JDK安装包上传到/opt下，可以通过XShel的rz上传，也可以⽤FileZila：

![image 8](<mac搭建hadoop集群.note_images/imageFile8.png>)

到/opt ⽬录下解压：tar xzvf jdk-8u181-linux-x64.tar.gz

![image 9](<mac搭建hadoop集群.note_images/imageFile9.png>)
...
![image 10](<mac搭建hadoop集群.note_images/imageFile10.png>)
...
![image 11](<mac搭建hadoop集群.note_images/imageFile11.png>)
...
![image 12](<mac搭建hadoop集群.note_images/imageFile12.png>)

- tjt03:


![image 13](<mac搭建hadoop集群.note_images/imageFile13.png>)
...
![image 14](<mac搭建hadoop集群.note_images/imageFile14.png>)

![image 15](<mac搭建hadoop集群.note_images/imageFile15.png>)
...
<table>
  <tr>
    <th>![image 16](<mac搭建hadoop集群.note_images/imageFile16.png>)</th>
  </tr>
</table>
...
<table>
  <tr>
    <th>![image 17](<mac搭建hadoop集群.note_images/imageFile17.png>)</th>
  </tr>
</table>


![image 18](<mac搭建hadoop集群.note_images/imageFile18.png>)
...
![image 19](<mac搭建hadoop集群.note_images/imageFile19.png>)

<table>
  <tr>
    <th>![image 20](<mac搭建hadoop集群.note_images/imageFile20.png>)</th>
  </tr>
</table>
...
<table>
  <tr>
    <th>![image 21](<mac搭建hadoop集群.note_images/imageFile21.png>)</th>
  </tr>
</table>


![image 22](<mac搭建hadoop集群.note_images/imageFile22.png>)
...
![image 23](<mac搭建hadoop集群.note_images/imageFile23.png>)

![image 24](<mac搭建hadoop集群.note_images/imageFile24.png>)

<table>
  <tr>
    <th>![image 25](<mac搭建hadoop集群.note_images/imageFile25.png>)</th>
  </tr>
</table>
...
<table>
  <tr>
    <th>![image 26](<mac搭建hadoop集群.note_images/imageFile26.png>)</th>
  </tr>
</table>


![image 27](<mac搭建hadoop集群.note_images/imageFile27.png>)
...
![image 28](<mac搭建hadoop集群.note_images/imageFile28.png>)

<table>
  <tr>
    <th>![image 29](<mac搭建hadoop集群.note_images/imageFile29.png>)</th>
  </tr>
</table>
...
<table>
  <tr>
    <th>![image 30](<mac搭建hadoop集群.note_images/imageFile30.png>)</th>
  </tr>
</table>


![image 31](<mac搭建hadoop集群.note_images/imageFile31.png>)
...
![image 32](<mac搭建hadoop集群.note_images/imageFile32.png>)
...
![image 33](<mac搭建hadoop集群.note_images/imageFile33.png>)
...
![image 34](<mac搭建hadoop集群.note_images/imageFile34.png>)

![image 35](<mac搭建hadoop集群.note_images/imageFile35.png>)

![image 36](<mac搭建hadoop集群.note_images/imageFile36.png>)

ResourceManager所在的机器上启动yarn；我的yarn配置在tjt02服务器上，⼀次需要到tjt02机器上启动yarn

![image 37](<mac搭建hadoop集群.note_images/imageFile37.png>)

- [root@tjt02 hadoop]# start-yarn.sh


![image 38](<mac搭建hadoop集群.note_images/imageFile38.png>)
...
![image 39](<mac搭建hadoop集群.note_images/imageFile39.png>)

![image 40](<mac搭建hadoop集群.note_images/imageFile40.png>)

![image 41](<mac搭建hadoop集群.note_images/imageFile41.png>)

- 在虚拟机tjt01上访问：htp:/172.16.14.130 5070


![image 42](<mac搭建hadoop集群.note_images/imageFile42.png>)

Datanode:

![image 43](<mac搭建hadoop集群.note_images/imageFile43.png>)
...
![image 44](<mac搭建hadoop集群.note_images/imageFile44.png>)

- 在虚拟机tjt02上访问：htp:/172.16.14.131 808/cluster


![image 45](<mac搭建hadoop集群.note_images/imageFile45.png>)
...
![image 46](<mac搭建hadoop集群.note_images/imageFile46.png>)

- 2、创建⽤户，设置⽂件权限 创建⽤户，修改密码： [root@tjt01 ~]# useradd tjt [root@tjt01 ~]# passwd tjt


![image 47](<mac搭建hadoop集群.note_images/imageFile47.png>)

设置tjt⽤户具有rot权限 修改 /etc/sudoers ⽂件，找到下⾯⼀⾏，在rot下⾯添加⼀⾏，如下所示:

![image 48](<mac搭建hadoop集群.note_images/imageFile48.png>)

修改完毕，现在可以⽤tjt帐号登录，然后⽤命令 su - ，即可获得rot权限进⾏操作。

![image 49](<mac搭建hadoop集群.note_images/imageFile49.png>)
