...
![image 1](<Kafka部署与代码实例.note_images/imageFile1.png>)
...
![image 2](<Kafka部署与代码实例.note_images/imageFile2.png>)

./zkServer.sh start

![image 3](<Kafka部署与代码实例.note_images/imageFile3.png>)
...
![image 4](<Kafka部署与代码实例.note_images/imageFile4.png>)
...
![image 5](<Kafka部署与代码实例.note_images/imageFile5.png>)
...
![image 6](<Kafka部署与代码实例.note_images/imageFile6.png>)
...
![image 7](<Kafka部署与代码实例.note_images/imageFile7.png>)
...
![image 8](<Kafka部署与代码实例.note_images/imageFile8.png>)
...
![image 9](<Kafka部署与代码实例.note_images/imageFile9.png>)

1.

- > JMS_PORT=9997 bin/kafka-server-start.sh config/server.properties &

![image 10](<Kafka部署与代码实例.note_images/imageFile10.png>)

broker.id=1 port=9093 ##其他配置和kafka-0保持⼀致

![image 11](<Kafka部署与代码实例.note_images/imageFile11.png>)
...
![image 12](<Kafka部署与代码实例.note_images/imageFile12.png>)
...
![image 13](<Kafka部署与代码实例.note_images/imageFile13.png>)
...
![image 14](<Kafka部署与代码实例.note_images/imageFile14.png>)
...
![image 15](<Kafka部署与代码实例.note_images/imageFile15.png>)
...
![image 16](<Kafka部署与代码实例.note_images/imageFile16.png>)
...
![image 17](<Kafka部署与代码实例.note_images/imageFile17.png>)
...
![image 18](<Kafka部署与代码实例.note_images/imageFile18.png>)
