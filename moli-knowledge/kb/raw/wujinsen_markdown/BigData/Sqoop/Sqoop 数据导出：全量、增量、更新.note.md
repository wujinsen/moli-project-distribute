...
![image 1](<Sqoop 数据导出：全量、增量、更新.note_images/imageFile1.png>)
...
![image 2](<Sqoop 数据导出：全量、增量、更新.note_images/imageFile2.png>)
...
![image 3](<Sqoop 数据导出：全量、增量、更新.note_images/imageFile3.png>)
...
![image 4](<Sqoop 数据导出：全量、增量、更新.note_images/imageFile4.png>)
