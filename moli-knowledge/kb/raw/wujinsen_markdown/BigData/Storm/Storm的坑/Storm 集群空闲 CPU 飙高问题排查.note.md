...
![image 1](<Storm 集群空闲 CPU 飙高问题排查.note_images/imageFile1.png>)
...
![image 2](<Storm 集群空闲 CPU 飙高问题排查.note_images/imageFile2.png>)
...
![image 3](<Storm 集群空闲 CPU 飙高问题排查.note_images/imageFile3.png>)

Disruptor Queue是LMAX开源的⼀个⽆锁内存队列。内部实现如下。

![image 4](<Storm 集群空闲 CPU 飙高问题排查.note_images/imageFile4.png>)
