...
![image 1](<使用Spark MLlib给豆瓣用户推荐电影.note_images/imageFile1.png>)

![image 2](<使用Spark MLlib给豆瓣用户推荐电影.note_images/imageFile2.png>)

然后这个模型为他推荐

![image 3](<使用Spark MLlib给豆瓣用户推荐电影.note_images/imageFile3.png>)

![image 4](<使用Spark MLlib给豆瓣用户推荐电影.note_images/imageFile4.png>)

![image 5](<使用Spark MLlib给豆瓣用户推荐电影.note_images/imageFile5.png>)

![image 6](<使用Spark MLlib给豆瓣用户推荐电影.note_images/imageFile6.png>)

![image 7](<使用Spark MLlib给豆瓣用户推荐电影.note_images/imageFile7.png>)
