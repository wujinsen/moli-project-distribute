...
![image 1](<GC调优在Spark应用中的实践.note_images/imageFile1.png>)
...
![image 2](<GC调优在Spark应用中的实践.note_images/imageFile2.png>)
...
![image 3](<GC调优在Spark应用中的实践.note_images/imageFile3.png>)
...
<table>
  ...
  <tr>
    <td>Stage*</td>
    <td>![image 4](<GC调优在Spark应用中的实践.note_images/imageFile4.png>)</td>
  </tr>
  <tr>
    <td>Task*</td>
    <td>![image 5](<GC调优在Spark应用中的实践.note_images/imageFile5.png>)</td>
  </tr>
  <tr>
    <td>CPU*</td>
    <td>![image 6](<GC调优在Spark应用中的实践.note_images/imageFile6.png>)</td>
  </tr>
  <tr>
    <td>Mem*</td>
    <td>![image 7](<GC调优在Spark应用中的实践.note_images/imageFile7.png>)</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td>Stage*</td>
    <td>Xmx8g<br><br>![image 8](<GC调优在Spark应用中的实践.note_images/imageFile8.png>)</td>
  </tr>
  <tr>
    <td>Task*</td>
    <td>![image 9](<GC调优在Spark应用中的实践.note_images/imageFile9.png>)</td>
  </tr>
  <tr>
    <td>CPU*</td>
    <td>![image 10](<GC调优在Spark应用中的实践.note_images/imageFile10.png>)</td>
  </tr>
  <tr>
    <td>Mem*</td>
    <td>![image 11](<GC调优在Spark应用中的实践.note_images/imageFile11.png>)</td>
  </tr>
</table>
...
![image 12](<GC调优在Spark应用中的实践.note_images/imageFile12.png>)
...
<table>
  ...
  <tr>
    <td>Stage*</td>
    <td>![image 13](<GC调优在Spark应用中的实践.note_images/imageFile13.png>)</td>
  </tr>
  <tr>
    <td>Task*</td>
    <td>![image 14](<GC调优在Spark应用中的实践.note_images/imageFile14.png>)</td>
  </tr>
  <tr>
    <td>CPU*</td>
    <td>![image 15](<GC调优在Spark应用中的实践.note_images/imageFile15.png>)</td>
  </tr>
  <tr>
    <td>Mem*</td>
    <td>![image 16](<GC调优在Spark应用中的实践.note_images/imageFile16.png>)</td>
  </tr>
</table>
