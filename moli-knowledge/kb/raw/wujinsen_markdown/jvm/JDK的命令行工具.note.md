![image 1](<JDK的命令行工具.note_images/imageFile1.png>)

![image 2](<JDK的命令行工具.note_images/imageFile2.png>)

jps：虚拟机进程状况⼯具

jsp命令格式： jps[options][hostid]

![image 3](<JDK的命令行工具.note_images/imageFile3.png>)

jps执⾏样例

![image 4](<JDK的命令行工具.note_images/imageFile4.png>)
...
![image 5](<JDK的命令行工具.note_images/imageFile5.png>)

jstat执⾏样例：jstat-gcutil 2764

![image 6](<JDK的命令行工具.note_images/imageFile6.png>)
...
![image 7](<JDK的命令行工具.note_images/imageFile7.png>)
...
![image 8](<JDK的命令行工具.note_images/imageFile8.png>)
...
![image 9](<JDK的命令行工具.note_images/imageFile9.png>)
