...
![image 1](<MongoDB 分片集群技术.note_images/imageFile1.png>)

当主库宕机后,两个从库都会进⾏竞选，其中⼀个变为主库，当原主库恢复后，作为从库加⼊当前的 复制集群即可。

![image 2](<MongoDB 分片集群技术.note_images/imageFile2.png>)
...
![image 3](<MongoDB 分片集群技术.note_images/imageFile3.png>)
...
![image 4](<MongoDB 分片集群技术.note_images/imageFile4.png>)
...
![image 5](<MongoDB 分片集群技术.note_images/imageFile5.png>)

![image 6](<MongoDB 分片集群技术.note_images/imageFile6.png>)

恢复。

![image 7](<MongoDB 分片集群技术.note_images/imageFile7.png>)
...
![image 8](<MongoDB 分片集群技术.note_images/imageFile8.png>)
...
![image 9](<MongoDB 分片集群技术.note_images/imageFile9.png>)
...
![image 10](<MongoDB 分片集群技术.note_images/imageFile10.png>)

这时候，各个shard 上的chunk数量就会不平衡。这时候，mongos中的⼀个组件balancer 就会执 ⾏⾃动平衡。把chunk从chunk数量最多的shard节点挪动到数量最少的节点。

![image 11](<MongoDB 分片集群技术.note_images/imageFile11.png>)
...
![image 12](<MongoDB 分片集群技术.note_images/imageFile12.png>)
...
![image 13](<MongoDB 分片集群技术.note_images/imageFile13.png>)
