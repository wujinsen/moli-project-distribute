...
![image 1](<mysql 同一张表查询 left join.note_images/imageFile1.png>)

需要写⼀个sql ，输出如下结果

![image 2](<mysql 同一张表查询 left join.note_images/imageFile2.png>)
...
![image 3](<mysql 同一张表查询 left join.note_images/imageFile3.png>)
