...
![image 1](<MySql的时区（serverTimezone）引发的血案.note_images/imageFile1.png>)

⽽现在电脑的时间是：

![image 2](<MySql的时区（serverTimezone）引发的血案.note_images/imageFile2.png>)
...
<table>
  <tr>
    <th>![image 3](<MySql的时区（serverTimezone）引发的血案.note_images/imageFile3.png>)</th>
  </tr>
</table>
...
<table>
  <tr>
    <th>![image 4](<MySql的时区（serverTimezone）引发的血案.note_images/imageFile4.png>)</th>
  </tr>
</table>
...
![image 5](<MySql的时区（serverTimezone）引发的血案.note_images/imageFile5.png>)
...
<table>
  <tr>
    <th>![image 6](<MySql的时区（serverTimezone）引发的血案.note_images/imageFile6.png>)</th>
  </tr>
</table>
