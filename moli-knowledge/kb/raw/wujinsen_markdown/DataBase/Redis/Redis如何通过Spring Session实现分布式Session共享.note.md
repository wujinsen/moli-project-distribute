...
![image 1](<Redis如何通过Spring Session实现分布式Session共享.note_images/imageFile1.png>)
...
![image 2](<Redis如何通过Spring Session实现分布式Session共享.note_images/imageFile2.png>)
...
![image 3](<Redis如何通过Spring Session实现分布式Session共享.note_images/imageFile3.png>)

### 配置notify-keyspace-events

如果不能在后台配置，可以通过⼯单联系售后⼯程师帮忙配置，例如阿⾥云：

![image 4](<Redis如何通过Spring Session实现分布式Session共享.note_images/imageFile4.png>)
