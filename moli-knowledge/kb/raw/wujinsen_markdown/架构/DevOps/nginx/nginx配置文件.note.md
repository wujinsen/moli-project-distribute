...
server { listen 8201; server_name localhost;
...
location / { rot /opt/dist/; #你vue打包dist的在Linux的地址 try_files $uri $uri/ /index.html; index index.html index.htm;

}

location /System/{ #vue访问后端接⼝地址 proxy_set_header Host $htp_host; proxy_set_header X-Real-IP $remote_adr; proxy_set_header REMOTE-HOST $remote_adr; proxy_set_header X-Forwarded-For $proxy_ad_x_forwarded_for; proxy_pas htp:/123.57.242.120 808/;
