...
![image 1](<CAP 定理的含义.note_images/imageFile1.png>)
...
![image 2](<CAP 定理的含义.note_images/imageFile2.png>)
...
![image 3](<CAP 定理的含义.note_images/imageFile3.png>)

接下来，⽤户的读操作就会得到 v1。这就叫⼀致性。

![image 4](<CAP 定理的含义.note_images/imageFile4.png>)

问题是，⽤户有可能向 G2 发起读操作，由于 G2 的值没有发⽣变化，因此返回的是 v0。G1 和 G2 读 操作的结果不⼀致，这就不满⾜⼀致性了。

![image 5](<CAP 定理的含义.note_images/imageFile5.png>)

为了让 G2 也能变为 v1，就要在 G1 写操作的时候，让 G1 向 G2 发送⼀条消息，要求 G2 也改成 v1。

![image 6](<CAP 定理的含义.note_images/imageFile6.png>)

这样的话，⽤户向 G2 发起读操作，也能得到 v1。

![image 7](<CAP 定理的含义.note_images/imageFile7.png>)
