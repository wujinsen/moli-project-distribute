...
<table>
  <tr>
    <th>![image 1](<Hystrix使用入门手册（中文）.note_images/imageFile1.png>)</th>
  </tr>
</table>
...
<table>
  <tr>
    <th>![image 2](<Hystrix使用入门手册（中文）.note_images/imageFile2.png>)</th>
  </tr>
</table>
...
![image 3](<Hystrix使用入门手册（中文）.note_images/imageFile3.png>)

Paste_Image.png HystrixCircuitBreaker（断路器的具体实现）：

![image 4](<Hystrix使用入门手册（中文）.note_images/imageFile4.png>)
...
![image 5](<Hystrix使用入门手册（中文）.note_images/imageFile5.png>)
...
![image 6](<Hystrix使用入门手册（中文）.note_images/imageFile6.png>)
...
![image 7](<Hystrix使用入门手册（中文）.note_images/imageFile7.png>)
...
![image 8](<Hystrix使用入门手册（中文）.note_images/imageFile8.png>)
...
![image 9](<Hystrix使用入门手册（中文）.note_images/imageFile9.png>)

复制代码

![image 10](<Hystrix使用入门手册（中文）.note_images/imageFile10.png>)
...
![image 11](<Hystrix使用入门手册（中文）.note_images/imageFile11.png>)
...
![image 12](<Hystrix使用入门手册（中文）.note_images/imageFile12.png>)
...
![image 13](<Hystrix使用入门手册（中文）.note_images/imageFile13.png>)

说明：启动服务后，输⼊localhost:8001/hystrix.stream，之后点击"Add Stream"，最后点击"Monitor Stream"即可。

![image 14](<Hystrix使用入门手册（中文）.note_images/imageFile14.png>)
