...
![image 1](<RxJava 从入门到放弃再到不离不弃.note_images/imageFile1.png>)
...
![image 2](<RxJava 从入门到放弃再到不离不弃.note_images/imageFile2.png>)
...
![image 3](<RxJava 从入门到放弃再到不离不弃.note_images/imageFile3.png>)

observeOn() 原理图：

![image 4](<RxJava 从入门到放弃再到不离不弃.note_images/imageFile4.png>)
...
![image 5](<RxJava 从入门到放弃再到不离不弃.note_images/imageFile5.png>)
...
![image 6](<RxJava 从入门到放弃再到不离不弃.note_images/imageFile6.png>)
