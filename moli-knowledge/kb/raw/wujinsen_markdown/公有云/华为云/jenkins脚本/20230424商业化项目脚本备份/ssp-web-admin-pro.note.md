...
- 57 echo "开始scp拷⻉jar包⾄服务器: ${serverArr[i]}"

scp /var/lib/jenkins/workspace/ssp-web-admin-pro/ssp-webadmin/target/*.war root@${serverArr[i]}:/home/xinwu/www/admin-ssp-web/wars;

- 58

- 59

ssh -p 22 -o 'StrictHostKeyChecking=no' root@${serverArr[i]} '/home/xinwu/www/admin-ssp-web/startup.sh'
...
- 68 // # 杀掉对应的进程 如果PID不存在,即该端⼝没有开启,则不执⾏

- 69 // if [ -n "$pid" ]; then

- 70 // echo '调⽤tomcat命令停⽌项⽬'
...
- 73 // daemonize /home/xinwu/www/admin-ssp-web/bin/startup.sh

- 74

// echo "启动项⽬完成"''', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: '/home/xinwu/www/admin-ssp-web/wars', remoteDirectorySDF: false, removePrefix: 'ssp-web-admin/target/', sourceFiles: 'ssp-webadmin/target/*.war', usePty: true)], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: true)])
...
- 13 /home/xinwu/www/admin-ssp-web/bin/shutdown.sh
...
- 22 /home/xinwu/www/admin-ssp-web/bin/startup.sh
