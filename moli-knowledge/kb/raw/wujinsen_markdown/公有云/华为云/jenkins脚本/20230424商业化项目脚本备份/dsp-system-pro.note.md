...
- 56 echo "开始scp拷⻉jar包⾄服务器: ${serverArr[i]}"

scp /var/lib/jenkins/workspace/dsp-system-pro/dspsystem/target/*.jar root@${serverArr[i]}:/home/xinwu/www/dsp-system

- 57

ssh -p 22 -o 'StrictHostKeyChecking=no' root@${serverArr[i]} '/home/xinwu/www/dsp-system/startup.sh restart'
...
nohup java $JAVA_OPTS -jar $workdir/$APP_NAME spring.profiles.active=prod &>> /home/xinwu/www/dsp-system/nohup.out &
