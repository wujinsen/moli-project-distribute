...
- 6 final def poolId = "083e3620-b3b7-4959-933b-816ef7647b79"; // 后端服务器组id

- 7 final def imageHost = "172.16.13.158"; //123.249.126.170 镜像服务器
...
- 169 /home/xinwu/www/dsp-new-api/startup.sh restart

echo "启动项⽬完成" ''', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: '/home/xinwu/www/dsp-new-api/', remoteDirectorySDF: false, removePrefix: 'dsp-api-web/target/', sourceFiles: 'dsp-api-web/target/*.jar', usePty: true)], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: true)])
...
scp -P 52077 -o 'StrictHostKeyChecking=no' /home/xinwu/www/dsp-new-api/dsp-api-web.jar root@${asServerList[i].address}:/home/xinwu/www/dsp-new-api/

- 198

ssh -p 52077 -o 'StrictHostKeyChecking=no' root@${asServerList[i].address} 'kill -9 8093; /home/xinwu/www/dsp-newapi/startup.sh restart'

- 199

- 200 echo "${asServerList[i].address} 启动项⽬完成"

""", execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: '/home/xinwu/www/dsp-new-api/', remoteDirectorySDF: false, removePrefix: 'dspapi-web/target/', sourceFiles: 'dsp-api-web/target/*.jar', usePty: true)], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: true)])
