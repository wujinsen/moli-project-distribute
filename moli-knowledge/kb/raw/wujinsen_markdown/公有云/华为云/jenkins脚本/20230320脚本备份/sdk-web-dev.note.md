...
- 6 final def poolId = "f1f7e4d0-162b-4588-b17a-372f1f4eec7f"; // 后端服务器组id
...
- 169 daemonize /home/xinwu/www/xwuad-sdk/bin/startup.sh

echo "启动项⽬完成" ''', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: '/home/xinwu/www/xwuad-sdk/wars', remoteDirectorySDF: false, removePrefix: 'sdk-web/target/', sourceFiles: 'sdk-web/target/*.war', usePty: true)], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: true)])
