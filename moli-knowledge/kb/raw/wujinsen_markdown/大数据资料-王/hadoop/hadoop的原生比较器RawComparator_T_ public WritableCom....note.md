...
![image 1](<hadoop的原生比较器RawComparator_T_ public WritableCom....note_images/imageFile1.png>)

⾸先，我们看 RawComparator的具体实现类WritableComparator：

![image 2](<hadoop的原生比较器RawComparator_T_ public WritableCom....note_images/imageFile2.png>)
