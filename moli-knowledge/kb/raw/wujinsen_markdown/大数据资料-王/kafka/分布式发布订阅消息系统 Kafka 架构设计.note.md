...
![image 1](<分布式发布订阅消息系统 Kafka 架构设计.note_images/imageFile1.png>)

![image 2](<分布式发布订阅消息系统 Kafka 架构设计.note_images/imageFile2.png>)

![image 3](<分布式发布订阅消息系统 Kafka 架构设计.note_images/imageFile3.png>)

![image 4](<分布式发布订阅消息系统 Kafka 架构设计.note_images/imageFile4.png>)

![image 5](<分布式发布订阅消息系统 Kafka 架构设计.note_images/imageFile5.png>)

![image 6](<分布式发布订阅消息系统 Kafka 架构设计.note_images/imageFile6.png>)

![image 7](<分布式发布订阅消息系统 Kafka 架构设计.note_images/imageFile7.png>)

![image 8](<分布式发布订阅消息系统 Kafka 架构设计.note_images/imageFile8.png>)

![image 9](<分布式发布订阅消息系统 Kafka 架构设计.note_images/imageFile9.png>)

![image 10](<分布式发布订阅消息系统 Kafka 架构设计.note_images/imageFile10.png>)
