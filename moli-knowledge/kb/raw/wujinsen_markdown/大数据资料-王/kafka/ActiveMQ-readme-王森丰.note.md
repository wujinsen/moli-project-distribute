...
![image 1](<ActiveMQ-readme-王森丰.note_images/imageFile1.png>)
...
![image 2](<ActiveMQ-readme-王森丰.note_images/imageFile2.png>)

点击那个红⾊⽅块可以⼿动停⽌运⾏程序。 运⾏玩receiver以后我们在运⾏sender，在运⾏完sender以后，我们要切换到receiver的console，如 下图所示：

![image 3](<ActiveMQ-readme-王森丰.note_images/imageFile3.png>)
