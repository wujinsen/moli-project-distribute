...
![image 1](<Hadoop Ambari 安装.note_images/imageFile1.png>)

和 Cloudera

![image 2](<Hadoop Ambari 安装.note_images/imageFile2.png>)
...
![image 3](<Hadoop Ambari 安装.note_images/imageFile3.png>)

![image 4](<Hadoop Ambari 安装.note_images/imageFile4.png>)

- 6. Confirm Hosts 的时候,需要注意⾥⾯的 Warning 信息,把相关的Warning都处理掉,有⼀些 Warning会导致安装出错.
- 7. 记住安装中所新建的⽤户,接下来需要⽤到这些⽤户.


![image 5](<Hadoop Ambari 安装.note_images/imageFile5.png>)

- 8. Hive和HBase Master 部署在同⼀个节点,这⾥当然你也可以分开. 设置好后就开始安装了.
- 9.如果安装失败的情况下,如何重新安装.


![image 6](<Hadoop Ambari 安装.note_images/imageFile6.png>)
...
![image 7](<Hadoop Ambari 安装.note_images/imageFile7.png>)
...
![image 8](<Hadoop Ambari 安装.note_images/imageFile8.png>)

查看 ganglia的监控

![image 9](<Hadoop Ambari 安装.note_images/imageFile9.png>)

查看 nagios 的监控

![image 10](<Hadoop Ambari 安装.note_images/imageFile10.png>)

# 测试

安装完成后,看着这些都正常了,是否需要⾃⼰验证⼀下呢? 不过基本跑了冒烟测试后,正常的话,基本 还是正常的,但是我们⾃⼰也得来操作下吧. 验证HDFS

![image 11](<Hadoop Ambari 安装.note_images/imageFile11.png>)

验证Map/Reduce

![image 12](<Hadoop Ambari 安装.note_images/imageFile12.png>)

验证HBase

![image 13](<Hadoop Ambari 安装.note_images/imageFile13.png>)

验证Hive

![image 14](<Hadoop Ambari 安装.note_images/imageFile14.png>)
