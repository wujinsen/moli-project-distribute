...
![image 1](<hbase源码系列（十二）Get、Scan在服务端是如何处理.note_images/imageFile1.png>)
...
![image 2](<hbase源码系列（十二）Get、Scan在服务端是如何处理.note_images/imageFile2.png>)
...
![image 3](<hbase源码系列（十二）Get、Scan在服务端是如何处理.note_images/imageFile3.png>)
...
![image 4](<hbase源码系列（十二）Get、Scan在服务端是如何处理.note_images/imageFile4.png>)
...
![image 5](<hbase源码系列（十二）Get、Scan在服务端是如何处理.note_images/imageFile5.png>)
...
![image 6](<hbase源码系列（十二）Get、Scan在服务端是如何处理.note_images/imageFile6.png>)
