...
![image 1](<Netty In Action.note_images/imageFile1.png>)
...
![image 2](<Netty In Action.note_images/imageFile2.png>)
...
![image 3](<Netty In Action.note_images/imageFile3.png>)
...
![image 4](<Netty In Action.note_images/imageFile4.png>)
...
![image 5](<Netty In Action.note_images/imageFile5.png>)
...
![image 6](<Netty In Action.note_images/imageFile6.png>)
...
![image 7](<Netty In Action.note_images/imageFile7.png>)
...
![image 8](<Netty In Action.note_images/imageFile8.png>)

下图显⽰的是Gather(聚合)，将多个ByteBuffer的数据写⼊到GatheringByteChannel：

![image 9](<Netty In Action.note_images/imageFile9.png>)
...
![image 10](<Netty In Action.note_images/imageFile10.png>)
...
![image 11](<Netty In Action.note_images/imageFile11.png>)
...
![image 12](<Netty In Action.note_images/imageFile12.png>)
...
![image 13](<Netty In Action.note_images/imageFile13.png>)
...
![image 14](<Netty In Action.note_images/imageFile14.png>)
...
![image 15](<Netty In Action.note_images/imageFile15.png>)
...
![image 16](<Netty In Action.note_images/imageFile16.png>)
...
![image 17](<Netty In Action.note_images/imageFile17.png>)
...
![image 18](<Netty In Action.note_images/imageFile18.png>)
...
![image 19](<Netty In Action.note_images/imageFile19.png>)
...
![image 20](<Netty In Action.note_images/imageFile20.png>)
...
![image 21](<Netty In Action.note_images/imageFile21.png>)
...
![image 22](<Netty In Action.note_images/imageFile22.png>)
...
![image 23](<Netty In Action.note_images/imageFile23.png>)
...
![image 24](<Netty In Action.note_images/imageFile24.png>)
...
![image 25](<Netty In Action.note_images/imageFile25.png>)
...
![image 26](<Netty In Action.note_images/imageFile26.png>)

若使⽤JDK的ByteBuffer就不能这样简单的实现，只能创建⼀个数组或创建⼀个新的ByteBuffer， 再将内容复制到新的ByteBuffer中。下⾯是使⽤CompositeByteBuf的例⼦：

[java] view plaincopy

![image 27](<Netty In Action.note_images/imageFile27.png>)
...
![image 29](<Netty In Action.note_images/imageFile29.png>)
...
![image 30](<Netty In Action.note_images/imageFile30.png>)
...
![image 31](<Netty In Action.note_images/imageFile31.png>)
...
![image 33](<Netty In Action.note_images/imageFile33.png>)

下图显⽰了调⽤clear()之后：

![image 34](<Netty In Action.note_images/imageFile34.png>)
...
![image 35](<Netty In Action.note_images/imageFile35.png>)
...
![image 36](<Netty In Action.note_images/imageFile36.png>)
...
![image 37](<Netty In Action.note_images/imageFile37.png>)
...
![image 38](<Netty In Action.note_images/imageFile38.png>)
...
![image 39](<Netty In Action.note_images/imageFile39.png>)
...
![image 40](<Netty In Action.note_images/imageFile40.png>)
...
![image 41](<Netty In Action.note_images/imageFile41.png>)
...
![image 42](<Netty In Action.note_images/imageFile42.png>)
...
![image 43](<Netty In Action.note_images/imageFile43.png>)
...
![image 44](<Netty In Action.note_images/imageFile44.png>)
...
![image 45](<Netty In Action.note_images/imageFile45.png>)
...
![image 46](<Netty In Action.note_images/imageFile46.png>)
...
![image 47](<Netty In Action.note_images/imageFile47.png>)
...
![image 48](<Netty In Action.note_images/imageFile48.png>)

#### 6.4 ChannelHandler和其⼦类

Netty中有3个实现了ChannelHandler接⼜的类，其中2个是接⼜，⼀个是抽象类。如下图：

![image 49](<Netty In Action.note_images/imageFile49.png>)
...
![image 50](<Netty In Action.note_images/imageFile50.png>)
...
![image 51](<Netty In Action.note_images/imageFile51.png>)
...
![image 52](<Netty In Action.note_images/imageFile52.png>)
...
![image 53](<Netty In Action.note_images/imageFile53.png>)
...
![image 54](<Netty In Action.note_images/imageFile54.png>)
...
![image 57](<Netty In Action.note_images/imageFile57.png>)
...
![image 58](<Netty In Action.note_images/imageFile58.png>)

上图显⽰了如何使⽤ChannelInitializer将SslHandler添加到ChannelPipeline，看下⾯代码：

###### [java] view plaincopy

![image 59](<Netty In Action.note_images/imageFile59.png>)
...
![image 60](<Netty In Action.note_images/imageFile60.png>)

![image 61](<Netty In Action.note_images/imageFile61.png>)
...
![image 62](<Netty In Action.note_images/imageFile62.png>)
...
![image 63](<Netty In Action.note_images/imageFile63.png>)
...
![image 64](<Netty In Action.note_images/imageFile64.png>)
...
![image 65](<Netty In Action.note_images/imageFile65.png>)
...
![image 66](<Netty In Action.note_images/imageFile66.png>)
...
![image 67](<Netty In Action.note_images/imageFile67.png>)
...
![image 68](<Netty In Action.note_images/imageFile68.png>)
...
![image 69](<Netty In Action.note_images/imageFile69.png>)
...
![image 70](<Netty In Action.note_images/imageFile70.png>)

###### 下⾯代码显⽰使⽤LineBasedFrameDecoder提取"\r\n"分隔帧：

[java] view plaincopy

![image 71](<Netty In Action.note_images/imageFile71.png>)
...
![image 72](<Netty In Action.note_images/imageFile72.png>)
...
![image 73](<Netty In Action.note_images/imageFile73.png>)
...
![image 74](<Netty In Action.note_images/imageFile74.png>)
...
![image 75](<Netty In Action.note_images/imageFile75.png>)
...
![image 76](<Netty In Action.note_images/imageFile76.png>)
...
![image 77](<Netty In Action.note_images/imageFile77.png>)
...
![image 78](<Netty In Action.note_images/imageFile78.png>)
...
![image 79](<Netty In Action.note_images/imageFile79.png>)
...
![image 80](<Netty In Action.note_images/imageFile80.png>)
...
![image 81](<Netty In Action.note_images/imageFile81.png>)

###### 下⾯代码显⽰了引导客户端使⽤NIO TCP传输：

[html] view plaincopy

![image 82](<Netty In Action.note_images/imageFile82.png>)
...
![image 83](<Netty In Action.note_images/imageFile83.png>)
...
![image 84](<Netty In Action.note_images/imageFile84.png>)
...
![image 85](<Netty In Action.note_images/imageFile85.png>)

看下⾯代码：

[java] view plaincopy

![image 86](<Netty In Action.note_images/imageFile86.png>)
...
![image 87](<Netty In Action.note_images/imageFile87.png>)
...
![image 88](<Netty In Action.note_images/imageFile88.png>)
...
![image 89](<Netty In Action.note_images/imageFile89.png>)
...
![image 90](<Netty In Action.note_images/imageFile90.png>)
...
![image 91](<Netty In Action.note_images/imageFile91.png>)

如上图所⽰，它可能会占⽤⼀个以上的“event”以获取⾜够的字节产⽣⼀个数据包，并将它传 递到ChannelPipeline中的下⼀个ChannelHandler，看下⾯代码：

[java] view plaincopy

![image 92](<Netty In Action.note_images/imageFile92.png>)
...
![image 93](<Netty In Action.note_images/imageFile93.png>)
...
![image 94](<Netty In Action.note_images/imageFile94.png>)

看下⾯代码：

[java] view plaincopy

![image 95](<Netty In Action.note_images/imageFile95.png>)
...
![image 96](<Netty In Action.note_images/imageFile96.png>)
...
![image 97](<Netty In Action.note_images/imageFile97.png>)
...
![image 98](<Netty In Action.note_images/imageFile98.png>)
...
![image 99](<Netty In Action.note_images/imageFile99.png>)
...
![image 100](<Netty In Action.note_images/imageFile100.png>)
...
![image 101](<Netty In Action.note_images/imageFile101.png>)
...
![image 102](<Netty In Action.note_images/imageFile102.png>)
...
![image 103](<Netty In Action.note_images/imageFile103.png>)
...
![image 104](<Netty In Action.note_images/imageFile104.png>)
...
![image 105](<Netty In Action.note_images/imageFile105.png>)

# 12.3 Netty中使⽤SPDY

⽀持SPDY的ChannelPipeline如下图：

![image 106](<Netty In Action.note_images/imageFile106.png>)

不⽀持SPDY的ChannelPipeline如下图：

![image 107](<Netty In Action.note_images/imageFile107.png>)
...
![image 108](<Netty In Action.note_images/imageFile108.png>)
...
![image 109](<Netty In Action.note_images/imageFile109.png>)
...
![image 110](<Netty In Action.note_images/imageFile110.png>)
...
![image 111](<Netty In Action.note_images/imageFile111.png>)
...
![image 112](<Netty In Action.note_images/imageFile112.png>)
...
![image 113](<Netty In Action.note_images/imageFile113.png>)
...
![image 114](<Netty In Action.note_images/imageFile114.png>)
...
![image 115](<Netty In Action.note_images/imageFile115.png>)
...
![image 116](<Netty In Action.note_images/imageFile116.png>)
...
![image 117](<Netty In Action.note_images/imageFile117.png>)
...
![image 118](<Netty In Action.note_images/imageFile118.png>)
...
![image 119](<Netty In Action.note_images/imageFile119.png>)
...
![image 120](<Netty In Action.note_images/imageFile120.png>)
...
![image 121](<Netty In Action.note_images/imageFile121.png>)
...
![image 122](<Netty In Action.note_images/imageFile122.png>)
...
![image 123](<Netty In Action.note_images/imageFile123.png>)
...
![image 124](<Netty In Action.note_images/imageFile124.png>)
...
![image 125](<Netty In Action.note_images/imageFile125.png>)
...
![image 126](<Netty In Action.note_images/imageFile126.png>)
...
![image 127](<Netty In Action.note_images/imageFile127.png>)
...
![image 128](<Netty In Action.note_images/imageFile128.png>)
...
![image 129](<Netty In Action.note_images/imageFile129.png>)
...
![image 130](<Netty In Action.note_images/imageFile130.png>)
...
![image 131](<Netty In Action.note_images/imageFile131.png>)
...
![image 132](<Netty In Action.note_images/imageFile132.png>)
...
![image 133](<Netty In Action.note_images/imageFile133.png>)
...
![image 134](<Netty In Action.note_images/imageFile134.png>)
...
![image 135](<Netty In Action.note_images/imageFile135.png>)
...
![image 136](<Netty In Action.note_images/imageFile136.png>)

###### 看下⾯代码：

[java] view plaincopy

![image 137](<Netty In Action.note_images/imageFile137.png>)
...
![image 138](<Netty In Action.note_images/imageFile138.png>)

###### 看下⾯代码：

[java] view plaincopy

![image 139](<Netty In Action.note_images/imageFile139.png>)
