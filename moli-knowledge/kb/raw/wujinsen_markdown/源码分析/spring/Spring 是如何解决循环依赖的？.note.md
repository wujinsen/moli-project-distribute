...
![image 1](<Spring 是如何解决循环依赖的？.note_images/imageFile1.png>)

第⼆种情况：两个对象之间的直接依赖

![image 2](<Spring 是如何解决循环依赖的？.note_images/imageFile2.png>)

### 第三种情况：多个对象之间的间接依赖

<table>
  <tr>
    <th>![image 3](<Spring 是如何解决循环依赖的？.note_images/imageFile3.png>)</th>
  </tr>
</table>
...
![image 4](<Spring 是如何解决循环依赖的？.note_images/imageFile4.png>)
...
<table>
  <tr>
    <th>![image 5](<Spring 是如何解决循环依赖的？.note_images/imageFile5.png>)</th>
  </tr>
</table>
...
<table>
  <tr>
    <th>![image 6](<Spring 是如何解决循环依赖的？.note_images/imageFile6.png>)</th>
  </tr>
</table>
...
<table>
  <tr>
    <th>![image 7](<Spring 是如何解决循环依赖的？.note_images/imageFile7.png>)</th>
  </tr>
</table>
...
<table>
  <tr>
    <th>![image 8](<Spring 是如何解决循环依赖的？.note_images/imageFile8.png>)</th>
  </tr>
</table>
...
![image 9](<Spring 是如何解决循环依赖的？.note_images/imageFile9.png>)
...
<table>
  <tr>
    <th>![image 10](<Spring 是如何解决循环依赖的？.note_images/imageFile10.png>)</th>
  </tr>
</table>
...
<table>
  <tr>
    <th>![image 11](<Spring 是如何解决循环依赖的？.note_images/imageFile11.png>)</th>
  </tr>
</table>
...
<table>
  <tr>
    <th>![image 12](<Spring 是如何解决循环依赖的？.note_images/imageFile12.png>)</th>
  </tr>
</table>
...
<table>
  <tr>
    <th>![image 13](<Spring 是如何解决循环依赖的？.note_images/imageFile13.png>)</th>
  </tr>
</table>
...
![image 14](<Spring 是如何解决循环依赖的？.note_images/imageFile14.png>)
...
<table>
  <tr>
    <th>![image 15](<Spring 是如何解决循环依赖的？.note_images/imageFile15.png>)</th>
  </tr>
</table>
...
<table>
  <tr>
    <th>![image 16](<Spring 是如何解决循环依赖的？.note_images/imageFile16.png>)</th>
  </tr>
</table>
