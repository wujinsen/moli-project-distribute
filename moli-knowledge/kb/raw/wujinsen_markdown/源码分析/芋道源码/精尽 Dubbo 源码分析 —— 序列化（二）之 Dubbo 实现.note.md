...
![image 1](<精尽 Dubbo 源码分析 —— 序列化（二）之 Dubbo 实现.note_images/imageFile1.png>)
...
![image 2](<精尽 Dubbo 源码分析 —— 序列化（二）之 Dubbo 实现.note_images/imageFile2.png>)
...
![image 3](<精尽 Dubbo 源码分析 —— 序列化（二）之 Dubbo 实现.note_images/imageFile3.png>)
...
![image 4](<精尽 Dubbo 源码分析 —— 序列化（二）之 Dubbo 实现.note_images/imageFile4.png>)
...
![image 5](<精尽 Dubbo 源码分析 —— 序列化（二）之 Dubbo 实现.note_images/imageFile5.png>)
...
![image 6](<精尽 Dubbo 源码分析 —— 序列化（二）之 Dubbo 实现.note_images/imageFile6.png>)
...
![image 7](<精尽 Dubbo 源码分析 —— 序列化（二）之 Dubbo 实现.note_images/imageFile7.png>)
...
![image 8](<精尽 Dubbo 源码分析 —— 序列化（二）之 Dubbo 实现.note_images/imageFile8.png>)
...
![image 9](<精尽 Dubbo 源码分析 —— 序列化（二）之 Dubbo 实现.note_images/imageFile9.png>)

Student 对应的 Builder 类

Info 对象的 Builder 类：

![image 10](<精尽 Dubbo 源码分析 —— 序列化（二）之 Dubbo 实现.note_images/imageFile10.png>)
