...
![image 1](<前端解决跨域问题的8种方案.note_images/imageFile1.png>)

![image 2](<前端解决跨域问题的8种方案.note_images/imageFile2.png>)

这个没什么好说的，因为script标签不受同源策略的限制。

![image 3](<前端解决跨域问题的8种方案.note_images/imageFile3.png>)
...
![image 4](<前端解决跨域问题的8种方案.note_images/imageFile4.png>)
...
![image 5](<前端解决跨域问题的8种方案.note_images/imageFile5.png>)
...
![image 6](<前端解决跨域问题的8种方案.note_images/imageFile6.png>)

cnblogs.com域名下的cs2.html:

![image 7](<前端解决跨域问题的8种方案.note_images/imageFile7.png>)
...
![image 8](<前端解决跨域问题的8种方案.note_images/imageFile8.png>)
...
![image 9](<前端解决跨域问题的8种方案.note_images/imageFile9.png>)
...
![image 10](<前端解决跨域问题的8种方案.note_images/imageFile10.png>)
...
![image 11](<前端解决跨域问题的8种方案.note_images/imageFile11.png>)

![image 12](<前端解决跨域问题的8种方案.note_images/imageFile12.png>)

![image 13](<前端解决跨域问题的8种方案.note_images/imageFile13.png>)
...
![image 14](<前端解决跨域问题的8种方案.note_images/imageFile14.png>)

- 6> CORS CORS背后的思想，就是使⽤⾃定义的HTTP头部让浏览器与服务器进⾏沟通，从⽽决定请求或响应是 应该成功，还是应该失败。 IE中对CORS的实现是xdr


![image 15](<前端解决跨域问题的8种方案.note_images/imageFile15.png>)
...
![image 16](<前端解决跨域问题的8种方案.note_images/imageFile16.png>)

其它浏览器中的实现就在xhr中

![image 17](<前端解决跨域问题的8种方案.note_images/imageFile17.png>)
...
![image 18](<前端解决跨域问题的8种方案.note_images/imageFile18.png>)

实现跨浏览器的CORS

![image 19](<前端解决跨域问题的8种方案.note_images/imageFile19.png>)
...
![image 20](<前端解决跨域问题的8种方案.note_images/imageFile20.png>)
...
![image 21](<前端解决跨域问题的8种方案.note_images/imageFile21.png>)

![image 22](<前端解决跨域问题的8种方案.note_images/imageFile22.png>)
