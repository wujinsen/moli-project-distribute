# -*- coding: utf-8 -*-
"""Generate 模擬問題6 markdown + 中文解析 from Moodle HTML."""
...
def build_zh_md(questions: list[dict], summary: dict) -> str:
    ...
    lines = [
        ...
        "related: [模擬問題1-中文解析, 模擬問題5-中文解析, サーティファイ対策]",
        f"created: {today}",
        f"updated: {today}",
        "---",
        "",
    ...
    lines.extend([
        ...
        "## 复习建议",
        "",
        "1. 本卷覆盖 **数制/浮点/概率/算法/CPU/存储/OS/DB/网络/SE/经营**；建议分块重做并对照 `_files` 插图手算。",
        "2. Q10、Q22、Q35、Q47～Q49 等计算题务必代入题面数字验算。",
