...
> 完整版本矩阵、模块依赖与兼容性说明见 [docs/TECH_STACK.md](docs/TECH_STACK.md)。
...
> 完整设计说明、流程图、表结构与扩展建议见 [docs/RBAC.md](docs/RBAC.md)。

---

## 相关文档

- [技术栈详细文档](docs/TECH_STACK.md)
- [RBAC 权限设计文档](docs/RBAC.md)
